...
Do not describe Cosmos-Reason2-2B as the final or best verifier. Treat it as the baseline currently wired through the `VLMBackend` protocol, and keep docs/configs open to a future Qwen/OpenAI-compatible backend.
